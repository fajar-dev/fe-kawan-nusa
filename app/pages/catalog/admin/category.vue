<template>
  <div class="flex flex-col w-full">
        ...
        <div class="flex items-center gap-4">
          <div>
            ...
            <p class="text-xs text-neutral-400 font-medium mt-0.5">
              <NuxtLink to="/" class="text-primary hover:underline">Home</NuxtLink> / Katalog Reward / Kategori
            </p>
          </div>
        </div>
      </div>
    ...
    <ModalConfirmDelete
      ...
      :message="`Apakah Anda yakin ingin menghapus kategori '${categoryToDelete?.name}'? Item katalog yang terhubung dengan kategori ini mungkin akan terpengaruh.`"
      :loading="deleting"
...
import { CircleHelp, SquarePen, Trash2 } from 'lucide-vue-next'
