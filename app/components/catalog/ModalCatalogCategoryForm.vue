        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-neutral-100">
          <div>
            <h3 class="text-lg font-semibold text-neutral-800 leading-tight">
              {{ category?.id ? 'Edit Kategori Katalog' : 'Tambah Kategori Baru' }}
            </h3>
            <p class="text-xs text-neutral-500 mt-0.5">Kelola kategori untuk item katalog</p>
          </div>
        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
          <div>
            ...
            <input 
              v-model="name" 
              type="text" 
              placeholder="Masukkan nama kategori katalog..." 
